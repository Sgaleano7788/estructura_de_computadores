...
# Este programa pide entre 3 y 5 números al usuario, luego muestra el menor de ellos.
...
main:
    ...
    li $t1, 2147483647        # $t1 almacena el menor número, inicializado al mayor entero posible
...
read_numbers:
    ...
    # Comparar el número actual con el menor hasta ahora
    bge $t1, $t3, update_min  # si el número actual es menor que el menor, actualizar
